...
After publishing:
- Monitor the [Drainpipe repository](https://github.com/Lullabot/drainpipe) for any immediate issues reported
- Update any dependent projects that require the new version
- Announce the release in relevant team channels
