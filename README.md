...
In your project's composer.json, under the "extra"."drupal-scaffold"."file-mapping" section, you can disable the generation of a specific file by mapping it to false. This prevents it from being created or updated during composer install/update. (Drainpipe workflows cannot be overridden).
