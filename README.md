...
Drupal scaffolds are core files automatically placed and updated in the project root by drupal/core-composer-scaffold.
Review the [documentation](https://www.drupal.org/docs/develop/using-composer/using-drupals-composer-scaffold#toc_4).
...
- github
  ...
  - workflows
    ...
    - PantheonReviewAppsDDEV.yml
    - PantheonReviewAppsManual.yml
    - PantheonReviewAppsManualDDEV.yml
    - Security.yml
    - TestFunctional.yml
    - TestStatic.yml
- gitignore
...
- gitlab
  ...
  - ComposerLockDiff.gitlab-ci.yml
  - DDEV.gitlab-ci.yml
...
- tugboat
  ...
  - steps
    ...
    - 4-online.sh.twig
  - config.yml.twig
  - settings.tugboat.php.twig
- Taskfile.yml
- phpstan.neon
- phpunit-testtraits.xml
- phpunit.xml

The Nightwatch scaffold files can be found [here](https://github.com/Lullabot/drainpipe/tree/main/drainpipe-dev/scaffold).
...
You can determine where a file is generated by reviewing the extra.drupal-scaffold section in composer.json.
In this project, you can also check each scaffolded file defined in [/src/ScaffoldInstallerPlugin.php](https://github.com/Lullabot/drainpipe/blob/main/src/ScaffoldInstallerPlugin.php)

The Nightwatch-specific scaffold files are defined in [drainpipe-dev/src/NightwatchScaffoldPlugin.php](https://github.com/Lullabot/drainpipe/blob/main/drainpipe-dev/src/NightwatchScaffoldPlugin.php).

In your project's composer.json, under the "extra"."drupal-scaffold"."file-mapping" section,
you can disable the generation of a specific file by mapping it to false.
This prevents it from being created or updated during composer install/update. (Drainpipe workflows cannot be overridden).
